...
rm query_header_chr*_OG_id.tsv_Orthogroup.txt ## avoid interference with blastdbcmd
...
ls query_header_chr*|while read R;do EN=$(echo $R|sed 's/query_header_//;s/OG_id.tsv_//'); mv $R $EN; blastdbcmd -db merged -entry_batch $EN -out $EN".fa";done
