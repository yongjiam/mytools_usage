...
#SBATCH --mem=64G
#SBATCH --export=NONE
srun --export=all -n 1 -c 28 bash runBITACORA.sh > OG_genes.log.txt
```
```
### runBITACORA.sh
#!/bin/bash
...
export PATH=$PATH:/scratch/pawsey0399/yjia/tools/miniconda3/bin

# PATH to BITACORA Scripts folder. 
SCRIPTDIR=/scratch/pawsey0399/yjia/tools/bitacora/Scripts
...
GEMOMAP=/scratch/pawsey0399/yjia/tools/miniconda3/share/gemoma-1.7.1-0/GeMoMa-1.7.1.jar
...
NAME=OrganismName  ##replace with variety name
